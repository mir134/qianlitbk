                ...
                initContainer: function() {
                    ...
                    this.searchContainer = this.container.find(".select2-search-field"), this.selection = t = this.container.find(n), this.search.bind("keydown", this.bind(function(e) {
                        if (this.enabled) {
                            ...
                            } else t.find(".select2-search-choice-focus").removeClass("select2-search-choice-focus"); if (this.opened()) switch (e.which) {
                                case C.UP:
                                case C.DOWN:
                                    return this.moveHighlight(e.which === C.UP ? -1 : 1), void d(e);
                                case C.ENTER:
                ...
                E && S.each(function() {
                    ...
                    if (!a[f]) {
                        if (o == _click) {
                            ...
                            t(r, !1, !0)
                        } else w && (/ut|nd/.test(o) ? (D[_remove](y), i[_remove](x)) : (D[_add](y), i[_add](x))); if (!_mobile) return !1;
                        n.stopPropagation()
                    }
